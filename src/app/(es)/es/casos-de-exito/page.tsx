...
const caseStudies = [
  {
    ...
    imageAlt: "Antes y después de reparación de fugas en villa de Lanzarote",
    problem:
  ...
  },
  {
    ...
    imageAlt: "Reparación fontanería piscina en Puerto del Carmen, Lanzarote",
    problem:
  ...
  },
  {
    ...
    imageAlt: "Trabajo de fontanería de urgencia en bloque de apartamentos en Costa Teguise",
    problem:
  ...
  },
  {
    ...
    imageAlt: "Detección de fugas en local comercial en Arrecife, Lanzarote",
    problem:
    ...
    <>
      ...
      <div className="relative h-64 md:h-80 rounded-xl overflow-hidden order-first md:order-last">
        <Image
          ...
          alt="Casos de éxito detección fugas Lanzarote"
          fill
            ...
            <div key={i} className="bg-charcoal-light border border-border/30 rounded-xl overflow-hidden">
              <div className="grid grid-cols-1 lg:grid-cols-3">
                <div className="relative h-48 lg:h-full min-h-[180px]">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 lg:inset-0 p-4 flex flex-col justify-end">
