...
export const metadata: Metadata = buildMetadata({
  title: "Contáctanos | Pipebusters Lanzarote",
  description:
    "Contacta con Pipebusters Lanzarote para servicios profesionales de detección de fugas y fontanería. Presupuesto gratis en toda Lanzarote.",
  path: "/es/contacto",
  locale: "es",
...
const breadcrumb = breadcrumbListSchema([
  ...
  { name: "Contacto", url: `${SITE.baseUrl}/es/contacto` },
]);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="relative h-64 md:h-80 rounded-xl overflow-hidden order-first md:order-last">
              <Image
                ...
                alt="Contacta con Pipebusters Lanzarote"
                fill
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Lunes &ndash; Viernes: 8:00 &ndash; 18:00
                        <br />
                        Sábado: 9:00 &ndash; 14:00
                        <br />
                        Urgencias: 24/7
                      </p>
                    </div>
