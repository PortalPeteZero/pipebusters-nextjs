...
export const metadata: Metadata = buildMetadata({
  title: "About Pipebusters | Leak Detection & Plumbing Lanzarote",
  description:
    ...
    <>
      ...
      <div className="relative h-64 md:h-80 rounded-xl overflow-hidden order-first md:order-last">
        <Image
          ...
          alt="Pipebusters Lanzarote team"
          fill
        ...
        <div className="container mx-auto">
          <div className="relative rounded-xl overflow-hidden max-w-5xl mx-auto h-64 md:h-96">
            <Image
              ...
              alt="Pipebusters service at a Lanzarote villa"
              fill
              className="object-cover"
            />
            ...
            <p className="absolute bottom-0 left-0 right-0 p-6 text-lg font-semibold text-foreground">
              Serving residential and commercial properties across all of Lanzarote
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-14 bg-charcoal">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-2xl font-bold mb-6">Serving All of Lanzarote</h2>
              <p className="text-muted-foreground mb-6">
                We provide services across the entire island, from Arrecife to Playa Blanca.
              </p>
            ...
            <div className="relative h-80 rounded-xl overflow-hidden">
              <Image
                ...
                alt="Pipebusters team working at an apartment complex in Lanzarote"
                fill
                className="object-cover"
              />
            </div>
